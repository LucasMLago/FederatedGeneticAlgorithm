#!/usr/bin/env python3
"""Trade-off, cold-start and alpha=0.1 figures as PDF + 300dpi PNG in analysis/figures/.
...
# fig4 reuses these colors for the alpha=0.1 arms
REGIMES = {
...
def fig2(rows: dict) -> None:
    ...
    # label positions tuned by hand to the current curves
